...
final readonly class QueryPostHandleMiddleware implements MiddlewareInterface
{
    ...
    public function process(
        ...
        if ($message instanceof QueryResultInterface) {
            $this->eventDispatcher->dispatch(new QueryPostHandleEvent($message));
